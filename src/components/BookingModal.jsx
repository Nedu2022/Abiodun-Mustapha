...
import { X, CheckCircle2, Send, Calendar, Clock, User, Mail, Phone, MessageSquare, Briefcase, Loader2, MapPin, Monitor, Users, Mic, ChevronDown } from 'lucide-react'
...
const inputClass =
  'w-full rounded-lg border border-cream/20 bg-charcoal-light px-4 py-3 text-[14px] text-cream outline-none transition-colors focus:border-gold placeholder:text-cream/30'

const labelClass =
  'flex items-center gap-1.5 text-[11px] font-medium uppercase tracking-[0.14em] text-cream/70'
          ...
          >
            ...
            <div className="flex items-center justify-between border-b border-cream/10 bg-charcoal-light px-6 py-5 sm:px-8">
              <div>
                ...
                <h3 className="font-display text-2xl text-cream">Invite Abiodun Mustapha</h3>
              </div>
              <button
                type="button"
                onClick={closeBookingModal}
                className="flex h-9 w-9 items-center justify-center rounded-full border border-cream/20 text-cream/70 transition-colors hover:border-gold hover:text-cream cursor-pointer"
              >
                <X className="h-5 w-5" />
              </button>
            </div>
            ...
            <div className="max-h-[80vh] overflow-y-auto p-6 sm:p-8">
              {status === 'success' ? (
                <div className="flex flex-col items-center py-8 text-center">
                  ...
                  <h4 className="font-display text-3xl text-cream">Invitation Sent!</h4>
                  ...
                  <button
                    type="button"
                    onClick={handleReset}
                    className="mt-8 rounded-full bg-gold px-8 py-3.5 text-[12px] font-medium uppercase tracking-[0.14em] text-white transition-colors hover:bg-gold-bright cursor-pointer"
                  >
                    Done
                  </button>
                </div>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                  <p className="text-[14px] leading-relaxed text-cream/70 border-l-2 border-gold/40 pl-4">
                  ...
                  <fieldset className="flex flex-col gap-4">
                    <legend className="text-[11px] font-medium uppercase tracking-[0.18em] text-gold mb-2">Contact Information</legend>
                  ...
                  <fieldset className="flex flex-col gap-4 border-t border-cream/10 pt-5">
                    <legend className="text-[11px] font-medium uppercase tracking-[0.18em] text-gold mb-2">Event Details</legend>
                  ...
                  <fieldset className="flex flex-col gap-4 border-t border-cream/10 pt-5">
                    <legend className="text-[11px] font-medium uppercase tracking-[0.18em] text-gold mb-2">Delivery Method</legend>
                  ...
                  <fieldset className="flex flex-col gap-4 border-t border-cream/10 pt-5">
                    <legend className="text-[11px] font-medium uppercase tracking-[0.18em] text-gold mb-2">Purpose & Expectations</legend>
                  ...
                  {/* Submit Button */}
                  <div className="mt-2 flex items-center justify-end gap-3 border-t border-cream/10 pt-5">
                    <button
                      type="button"
                      onClick={closeBookingModal}
                      className="px-5 py-3 text-[12px] font-medium uppercase tracking-[0.12em] text-cream/70 transition-colors hover:text-cream cursor-pointer"
                    >
                      Cancel
                    </button>
                    <button
                      ...
                      className="inline-flex items-center justify-center gap-2 rounded-full bg-gold px-7 py-3.5 text-[12px] font-medium uppercase tracking-[0.14em] text-white transition-colors hover:bg-gold-bright disabled:opacity-50 cursor-pointer"
                    >
                      {status === 'submitting' ? (
                        <>
